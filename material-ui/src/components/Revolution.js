...
const Revolution = (props) => {
    ...
    return (
        <Grid container direction='column'>
                ...
                <Grid item container direction='column' lg style={{maxWidth: '40em'}}>
                    ...
                    <Grid item>
                        <Typography variant='body1' paragraph align={matchesMD ? 'center' : 'right'}>
                            The rise of computerse, and subsequently the Internet, has completely altered every aspect of human life.
                            This has increased our comfort, broadened our connections, and reshaped how we view the world.
                        </Typography>
                        <Typography variant='body1' paragraph align={matchesMD ? 'center' : 'right'}>
                            What once was confied to huge rooms and teams of engineers now resides in every single on of our hands.
                        ...
                        <Typography variant='body1' paragraph align={matchesMD ? 'center' : 'right'}>
                            ...
                            The best way to predict the future is to be the one building it, and we want to help guide the world into this next chapter of technological expansion, exploration and innovation.
                        </Typography>
                        <Typography variant='body1' paragraph align={matchesMD ? 'center' : 'right'}>
                            We see a future where very individual has personalized software custom tailored to their lifestyle, culture, and interests, helping them overcome life's obstacles.
                            Each project isa step towards that goal.
                        </Typography>
                        <Typography variant='body1' paragraph align={matchesMD ? 'center' : 'right'}>
                        </Typography>
                    </Grid>
            ...
            <Grid item container direction={ matchesMD ? 'column' : 'row' } alignItems='center' className={classes.rowContainer} style={{marginTop: '10em', marginBottom: '10em'}}>
                <Grid item container direction='column' lg style={{maxWidth: '40em'}}>
                    ...
                    <Grid item>
                        ...
                        <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined}>
                            Instead of chaining together long individual pages, like traditional websites, React websites are build with little chuncks of code called components.
                            These components are faster, easier to maintain, and are easily reused and customized, each serving a singular purpose.
                        </Typography>
                        <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined}>
                            Two years later, they shocked the world by releasing a simlar system, React Native, for producing iOS and Android apps.
                            Instead of having to master two completely separate development platforms, you can leverage the knowledge you already possessed from building websites and reapply it directly!
                            This was a huge leap forward.
                        </Typography>
                        <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined}>
                            This technology is now being used by companies like AirBnB, Microsoft, Netflix, Pintrest, Skype, Tesla, UberEats, and when Facebook purchased Instagram, large portions of it were even rebuilt using React.
                        </Typography>
                        <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined}>
                        ...
                        <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined}>
                            These technical advancements translate into savings by significantly reducting the workload and streamlining the workflow for developing new pieces of software, while also lowering the barrier to entry for mobile app development.
                        </Typography>
                        <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined}>
                            This puts personalization in your pocket - faster, better, and more affordable than even before.
                        </Typography>
                    </Grid>
                </Grid>
            ...
            <Grid item container direction={matchesMD ? 'column' : 'row' } justify='center' className={classes.rowContainer} style={{backgroundColor: '#b3b3b3', height: '90em'}}>
                <Grid item container direction='column' alignItems={matchesMD ? 'center': undefined} lg>
                    ...
                    <Grid item>
                        <Typography variant='body1' paragraph style={{ color: '#FFF', maxWidth: '20em'}} align={matchesMD ? 'center' : undefined}>
                            ...
                            Whether you already have an idea for where to start and what to do, or if you just know you want to step things up, our initial consultation will help you examine your business holistically to find the best solutions.
                        </Typography>
                        <Typography variant='body1' paragraph style={{ color: '#FFF', maxWidth: '20em' }} align={matchesMD ? 'center' : undefined}>
                            Detailed notes will be taken on your requirements and constraings, while taking care to identify other potential areas for consideration.
                        </Typography>
                        <Typography variant='body1' paragraph style={{ color: '#FFF', maxWidth: '20em' }} align={matchesMD ? 'center' : undefined}>
                            Cutting-edge advancements in machine learning like object detection and natural language processing allow computers to do things previously unimaginable, and our expertise and intuition will help usher you into the new future of possibilities.
                        </Typography>
                    </Grid>
                </Grid>
            ...
            <Grid item container direction={matchesMD ? 'column' : 'row' } justify='center' className={classes.rowContainer} style={{backgroundColor: '#ff7373', height: '90em'}}>
                <Grid item container direction='column' lg alignItems={matchesMD ? 'center': undefined}>
                    ...
                    <Grid item>
                        ...
                        <Typography variant='body1' paragraph style={{ color: '#FFF', maxWidth: '20em' }} align={matchesMD ? 'center' : undefined}>
                            ...
                            That's just a fancy term for a mockup, which doesn't include colours, images, or any other polished design elements, but captures the essential layout structure and functionality.
                        </Typography>
                        <Typography variant='body1' paragraph style={{ color: '#FFF', maxWidth: '20em' }} align={matchesMD ? 'center' : undefined}>
            ...
            <Grid item container direction={matchesMD ? 'column' : 'row' } justify='center' className={classes.rowContainer} style={{backgroundColor: '#39b54a', height: '90em'}}>
                <Grid item container direction='column' lg alignItems={matchesMD ? 'center': undefined}>
                    <Grid item>
                    ...
                    <Grid item>
                        ...
                        <Typography variant='body1' paragraph style={{ color: '#FFF', maxWidth: '20em' }} align={matchesMD ? 'center' : undefined}>
                            Once you're completely satisfied with the vision for our solutions, we get down to the nitty gritty, fine-details of design.
                        </Typography>
                    </Grid>
                </Grid>
                <Grid item lg style={{alignSelf: 'center'}}>
            ...
            <Grid item container direction={matchesMD ? 'column' : 'row' } justify='center' className={classes.rowContainer} style={{backgroundColor: '#a67c52', height: '90em'}}>
                <Grid item container direction='column' lg alignItems={matchesMD ? 'center': undefined}>
                    <Grid item>
                    ...
                    <Grid item>
                        <Typography variant='body1' paragraph style={{ color: '#FFF', maxWidth: '20em'}} align={matchesMD ? 'center' : undefined}>
                            ...
                            This also involves using any brand material like fonts, colours, and logos to extend the experience you're already famlilar with.
                        </Typography>
                        <Typography variant='body1' paragraph style={{ color: '#FFF', maxWidth: '20em' }} align={matchesMD ? 'center' : undefined}>
            ...
            <Grid item container direction={matchesMD ? 'column' : 'row' } justify='center' className={classes.rowContainer} style={{backgroundColor: '#39b54a', height: '90em'}}>
                <Grid item container direction='column' lg alignItems={matchesMD ? 'center': undefined}>
                    ...
                    <Grid item>
                        ...
                        <Typography variant='body1' paragraph style={{ color: '#FFF', maxWidth: '20em' }} align={matchesMD ? 'center' : undefined}>
                            This time we'll be going over the finalized designes in another fully interactive demonstration.
            ...
            <Grid item container direction={matchesMD ? 'column' : 'row' } justify='center' className={classes.rowContainer} style={{backgroundColor: '#fbb03b', height: '90em'}}>
                <Grid item container direction='column' lg alignItems={matchesMD ? 'center': undefined}>
                    <Grid item>
                    ...
                    <Grid item>
                        ...
                        <Typography variant='body1' paragraph style={{ color: '#FFF', maxWidth: '20em'}} align={matchesMD ? 'center' : undefined}>
                            ...
                            because we use extensive testing to guarentee compatibility with all intended devices.
                        </Typography>
                        <Typography variant='body1' paragraph style={{ color: '#FFF', maxWidth: '20em'}} align={matchesMD ? 'center' : undefined}>
                            Only after our rigorous examinations will we accept a product as finished, then pushing it through the production pipeline.
            ...
            <Grid item container direction={matchesMD ? 'column' : 'row' } justify='center' className={classes.rowContainer} style={{backgroundColor: '#c1272d', height: '90em'}}>
                <Grid item container direction='column' lg alignItems={matchesMD ? 'center': undefined}>
                    <Grid item>
                    ...
                    <Grid item>
                        ...
                        <Typography variant='body1' paragraph style={{ color: '#FFF', maxWidth: '20em' }} align={matchesMD ? 'center' : undefined}>
                            ...
                            We'll give our final demonstration to show off your shiny new software in the wild so you know exactly how it will look to your users.
                        </Typography>
                        <Typography variant='body1' paragraph style={{ color: '#FFF', maxWidth: '20em' }} align={matchesMD ? 'center' : undefined}>
            ...
            <Grid item container direction={matchesMD ? 'column' : 'row' } justify='center' className={classes.rowContainer} style={{backgroundColor: '#8e45ce', height: '90em'}}>
                <Grid item container direction='column' lg alignItems={matchesMD ? 'center': undefined}>
                    <Grid item>
                    ...
                    <Grid item>
                        ...
                        <Typography variant='body1' paragraph style={{ color: '#FFF', maxWidth: '20em' }} align={matchesMD ? 'center' : undefined}>
                            After a successful launch, we keep in close contact to listen to feedback and hear how the project has been received.
                        </Typography>
                        <Typography variant='body1' paragraph style={{ color: '#FFF', maxWidth: '20em' }} align={matchesMD ? 'center' : undefined}>
                            From there on out, we make sure your application is kept up to date and taking advantage of the best features and practicies available.
            ...
            <Grid item container direction={matchesMD ? 'column' : 'row' } justify='center' className={classes.rowContainer} style={{backgroundColor: '#29abe2', height: '90em'}}>
                <Grid item container direction='column' lg alignItems={matchesMD ? 'center': undefined}>
                    <Grid item>
