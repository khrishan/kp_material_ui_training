...
const CustomSoftware = (props) => {
    ...
    return (
        <Grid container direction='column'>
            ...
            <Grid item container direction={matchesMD ? 'column' : 'row'} alignItems={matchesMD ? 'center' : undefined} justify='space-around'  className={classes.rowContainer}>
            ...
            <Grid item container direction={matchesMD ? 'column' : 'row'} alignItems={matchesMD ? 'center' : undefined} justify='space-around' style={{marginBottom: '20em'}}  className={classes.rowContainer}>
                <Grid item container className={classes.itemsContainer} md style={{ marginBottom: matchesMD ? '15em': 0}} direction={matchesSM ? 'column' : 'row'}>
                    <Grid item container direction='column' md>
                        <Grid item>
                    ...
                    <Grid item md direction={matchesSM ? 'column' : 'row'}>
