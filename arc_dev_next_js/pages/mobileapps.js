    ...
    return (
        <Grid container direction='column'>
            <Head>
                ...
                <meta name='description' key='description' content='Mobile Apps Made Easy | Our cutting-edge mobile app development process lets us build beautifully designed, carefully crafted apps both for iOS and Android.' />
                <meta property='og:title' key='og:title' content='Bringing West Coast Technology to the Midwest | iOS/Android App Development' />
                <meta property='og:url' key='og:url' content='https://arc.com/mobileapps' />
            ...
            <Grid item container direction='row' justify={matchesMD ? 'center' : undefined} className={classes.rowContainer} style={{marginTop : matchesXS ? '1em' : '2em'}}>
                ...
                <Grid item container direction='column' className={classes.heading}>
                    <Grid item>
                        <Typography align={matchesMD ? 'center' : undefined} style={{lineHeight : matchesXS ? 1.1 : null, marginBottom : matchesXS ? '0.5em' : null, fontSize : '2.25em'}} variant='h1'>iOS/Andriod Development</Typography>
                    </Grid>
                    <Grid item>
                        <Typography align={matchesMD ? 'center' : undefined} variant='body1' paragraph>
                            Mobile aps allow you to take your tools on the go.
                        </Typography>
                        <Typography align={matchesMD ? 'center' : undefined} variant='body1' paragraph>
                            ...
                            This opens you up to a whole new world fo possibilities by taking advantage of phone features like the camera, GPS, push notifications, and more.
                        </Typography>
                        <Typography align={matchesMD ? 'center' : undefined} variant='body1' paragraph>
                            Convenienve. Connection.
                        </Typography>
                    </Grid>
                </Grid>
                <Hidden mdDown>
                    <Grid item className={classes.arrowContainer}>
                        <IconButton style={{ backgroundColor : 'transparent'}}  component={Link} href='/websites' onClick={() => props.setSelectedIndex(3)}>
                            <img src='/assets/forwardArrow.svg' alt='Forward to Websites Development Page' />
                        </IconButton>
                    </Grid>
                </Hidden>
            </Grid>
