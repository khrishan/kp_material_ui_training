...
const About = (props) => {
    ...
    return (
        ...
        <Head>
            ...
            <meta property='og:url' key='og:url' content='https://arc.com/about' />
            ...
            <Grid item container justify='center' className={classes.rowContainer} style={{marginTop: '3em'}}>
                <Typography variant='h4' align='center' className={classes.missionStatement}>
                    ...
                    Arc Development will use that principle to provide fast, modern, inexpensive, and aesthetic software to the Midwest and beyond.
                </Typography>
            </Grid>
            <Grid item container className={classes.rowContainer} justify='space-around' direction={matchesMD ? 'column' : 'row'} alignItems={matchesMD ? 'center' : undefined} style={{ marginTop: '10em', marginBottom: '10em' }}>
                    ...
                    <Grid item container direction='column' lg style={{maxWidth: '35em'}}>
                        ...
                        <Grid item>
                            ...
                            <Typography variant='body1' paragraph align={matchesMD ? 'center': undefined }>
                                ...
                                There are many different answers to that question: exonomic barriers, social barriers, educational barriers, and sometimes institutional barriers.
                            </Typography>
                            <Typography variant='body1' paragraph align={matchesMD ? 'center': undefined }>
                                We aim to be a powerful force in overcoming these obstables.
                                Recent developments in software engineering and computing power, compunded by the proliferation of smart phones, has opened up infinite worlds of possibility.
                                Things that have always been done by hand can now be done digitally and automatically, and completely new methods of iteraction are created daily.
                ...
                <Grid item>
                    <Grid item container justify='center' style={{maxHeight: matchesMD ? 200 : '22em'}} lg>
                        <img src='/assets/history.svg' alt='quill pen sitting on top of book' />
                    </Grid>
                </Grid>
            </Grid>
            <Grid item container direction='column' className={classes.rowContainer} alignItems='center' style={{marginBottom: '15em'}}>
                <Grid item>
                    <Typography variant='h4' align='center' gutterBottom style={{marginTop: matchesMD ? '1.25em' : 0 }}>Team</Typography>
                </Grid>
                <Grid item>
                ...
                <Grid item container justify={matchesMD ? 'center' : undefined}>
                    <Hidden lgUp>
                        <Grid item lg style={{maxWidth: '45em', padding:'1.25em'}}>
                            <Typography variant='body1' align='center' paragraph>
                                ...
                                - learning about computers, learning mathematics and philosphy, studying design, always just learning.
                            </Typography>
                            <Typography variant='body1' align='center' paragraph>
                    ...
                    <Grid item container direction='column' lg alignItems={matchesMD ? 'center' : undefined} style={{ marginBottom : matchesMD ? '2.5em' : 0 }}>
                        ...
                        <Grid item>
                            <Typography variant='caption'>Page from my sophomore yearbook</Typography>
                        </Grid>
                    </Grid>
                    <Hidden mdDown>
                        <Grid item lg style={{maxWidth: '45em', padding:'1.25em'}}>
                    ...
                    <Grid item container direction='column' lg alignItems={matchesMD ? 'center' : 'flex-end'}>
                        <Grid item>
                            <img src='/assets/puppy.svg' alt='grey spotted puppy' />
                        </Grid>
                        <Grid item>
