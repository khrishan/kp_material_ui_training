    ...
    return (
        <Grid container direction='column'>
            <Head>
                ...
                <meta name='description' key='description' content='Visionary insights couples with cutting-edge technology is a recipe for revolution. Get a free online estimate instantly!' />
                <meta property='og:title' key='og:title' content='Bringing West Coast Technology to the Midwest | The Revolution' />
                <meta property='og:url' key='og:url' content='https://arc.com/revolution' />
            ...
            {sections.map(section => (
                <Grid item container direction={matchesMD ? 'column' : 'row' } justify='center' className={classes.rowContainer} style={{backgroundColor: section.backgroundColor, height: '90em'}}>
                    <Grid item container direction='column' alignItems={matchesMD ? 'center': undefined} lg>
                        <Grid item>
                            <Typography variant='h4' align={matchesMD ? 'center' : undefined} gutterBottom style={{ color: '#000', marginTop: '5em' }}>{section.title}</Typography>
                        </Grid>
                        <Grid item>
